...
int SPP_class::access_ST(int tag, int curr_block, int type)
{
    int i, match_idx = -1;
...
int SPP_class::update_signature(int assoc, int type)
{
...
void SPP_class::update_counter(int match_idx, bool miss)
{
...
void SPP_class::update_PT(int tag)
{
    int i, match_idx = -1;
...
int SPP_class::read_PT(int conf, int la_depth)
{
...
bool SPP_class::check_filter(int tag, int block, int type)
{
...
void SPP_class::update_lru(int match_idx, bool invalid, int type)
{
    int i, num_entry;
	switch (type) {
		case FROM_ST:
